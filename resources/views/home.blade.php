...
<link rel="stylesheet" href="{{asset('app-assets/fonts/meteocons/style.min.css')}}">
<link rel="stylesheet" href="{{asset('app-assets/vendors/css/charts/morris.css')}}">
<link rel="stylesheet" href="{{asset('app-assets/vendors/css/charts/chartist.css')}}">
<link rel="stylesheet" href="{{asset('app-assets/vendors/css/charts/chartist-plugin-tooltip.css')}}">
<link rel="stylesheet" href="{{asset('app-assets/vendors/css/ui/jquery-ui.min.css')}}">
@endsection
...
<link rel="stylesheet" href="{{asset('app-assets/css/core/colors/palette-gradient.min.css')}}">
<link rel="stylesheet" href="{{asset('app-assets/css/pages/timeline.min.css')}}">
<link rel="stylesheet" href="{{asset('app-assets/css/pages/dashboard-ecommerce.min.css')}}">
<link rel="stylesheet" href="{{asset('app-assets/css/plugins/ui/jqueryui.css')}}">
@endsection
...
<div class="app-content content">
    ...
    <div class="content-wrapper">
        <div class="content-body">
            <div class="card bg-gradient-x-info mb-1">
                <div class="row">
                    <div class="col-md-3">
                        <img src="{{asset('app-assets/images/pages/wellcome.png')}}" alt="" class="img-wellcome">
                    </div>
                    <div class="col-md-9">
                        <div class="card-body">
                            <h6 class="card-title font-large-1 text-white">
                                <b>
                                    Selamat Datang, {{ \Auth::user()->role }}
                                </b>
                            </h6>

                            <p class="font-medium-3 text-white">
                                Ini merupakan aplikasi Pegawai Pemerintah Non Pegawai Negeri(PPNPN) Versi Beta.
                            </p>
                            <p class="float-left font-medium-1 text-white" id="date">
                            </p>
                            <p class="float-left font-medium-1 text-white">,
                            </p>
                            <p class="float-left font-medium-1 text-white" id="time" style="margin-left: 2px;">
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h2 class="info">{{ $administrators->count() }}</h2>
                                        <h4>Admin</h4>
                                    </div>
                                    <div>
                    ...
                    <div class="card pull-up">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h2 class="success">146</h2>
                                        <h4>Data Pelamar</h4>
                                    </div>
                                    <div>
                                        <i class="icon-user-following success font-large-3 float-right"></i>
                                    </div>
                                </div>
                                <div class="pgbar-striped-animated ui-progressbar-striped-animated ui-progressbar ui-corner-all ui-widget ui-widget-content mt-1 mb-0 box-shadow-2" style="height: 14px;" role="progressbar" aria-valuemin="1" aria-valuemax="100" aria-valuenow="100">
                                    <div class="ui-progressbar-value ui-corner-left ui-widget-header progress-bar bg-success" style="width: 100%;">100%</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card pull-up">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h2 class="danger">99.89 %</h2>
                                        <h4>Data Pelamar</h4>
                                    </div>
                                    <div>
                                        <i class="icon-user-unfollow danger font-large-3 float-right"></i>
                                    </div>
                                </div>
                                <div class="pgbar-striped-animated ui-progressbar-striped-animated ui-progressbar ui-corner-all ui-widget ui-widget-content mt-1 mb-0 box-shadow-2" style="height: 14px;" role="progressbar" aria-valuemin="1" aria-valuemax="100" aria-valuenow="100">
                                    <div class="ui-progressbar-value ui-corner-left ui-widget-header progress-bar bg-danger" style="width: 100%;">100%</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="card-body">
                            ...
                            <p class="font-medium-3 text-white">
                                Ini merupakan aplikasi Pegawai Pemerintah Non Pegawai Negeri(PPNPN) Versi Beta. Silahkan klik daftar untuk mendaftar, tombol akan berubah jika sudah mendaftar.
                            </p>
                            <p class="float-left font-medium-1 text-white" id="date">
                            </p>
                            <p class="float-left font-medium-1 text-white">,
                        ...
                        <a href="{{ route('data_pelamar.index') }}" class="btn btn-warning btn-glow btn-round float-right mr-1" style="margin-bottom: 9px;">Daftar Sekarang</a>
                        <a href="{{ route('data_pelamar.show', $data_pelamars->no_ktp) }}" class="btn btn-warning btn-glow btn-round float-right mr-1" style="margin-bottom: 9px;">Lihat Hasil</a>
                    </div>
                </div>
            </div>
            <!-- eCommerce statistic -->
...
@endif
@include('__FUNCTION.timeToday')
@include('__FUNCTION.dateToday')
@endsection

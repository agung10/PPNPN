    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Ubah Admin</h3>
        ...
        <div class="content-body">
            ...
            <section id="basic-form-layouts">
                <form method="POST" action="{{ route('tambahAdmin.update', $administrators->id) }}" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card border-top-blue border-top-3 box-shadow-1">
                                ...
                                <div class="card-body">
                                    ...
                                    @else
                                        <input type="file" id="input-file-events" class="dropify-event" data-default-file="{{asset('app-assets/images/profile/img_upload/Administrator/'.$administrators->profile)}}" name="profile">
                                    @endif
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="name" class="form-control" placeholder="Masukan Nama" name="name" value="{{ $administrators->name }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="email">E-mail Address</label>
                                                        <input type="email" id="email" class="form-control" placeholder="Masukan E-mail" name="email" value="{{ $administrators->email }}" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="password">Kata Sandi</label>
                                                        <input type="password" id="password" class="form-control" placeholder="Isi Jika Ingin Mengubah Kata Sandi" name="password">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
